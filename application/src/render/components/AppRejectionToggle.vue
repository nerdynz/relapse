<template>
  <div class="app-capture-toggle" :class="cssClass">
    <div class="capturing toggle-btn" @click="this.$emit('input', 'CAPTURING')">
      <!-- <ico icon="camera-polaroid" size="small" /> -->
      Capture
    </div>
    <div class="reject toggle-btn" @click="this.$emit('input', 'REJECTING')">
      Reject
    </div>
  </div>
</template>
