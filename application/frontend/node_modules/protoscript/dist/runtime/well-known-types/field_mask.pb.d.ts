...
export declare const FieldMask: {
     ...
     */
    initialize: (msg?: Partial<FieldMask>) => FieldMask;
    /**
     * @private
     */
    _writeMessage: (msg: PartialDeep<FieldMask>, writer: protoscript.BinaryWriter) => protoscript.BinaryWriter;
    /**
     * @private
     */
    _readMessage: (msg: FieldMask, reader: protoscript.BinaryReader) => FieldMask;
};
