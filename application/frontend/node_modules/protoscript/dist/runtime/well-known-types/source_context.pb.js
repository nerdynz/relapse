...
export const SourceContext = {
     ...
     */
    encode: function (msg) {
        return SourceContext._writeMessage(msg, new protoscript.BinaryWriter()).getResultBuffer();
    },
    /**
     * Deserializes SourceContext from protobuf.
     */
    decode: function (bytes) {
        return SourceContext._readMessage(SourceContext.initialize(), new protoscript.BinaryReader(bytes));
    },
    /**
