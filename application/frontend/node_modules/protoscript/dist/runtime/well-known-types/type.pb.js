...
export const Type = {
     ...
     */
    encode: function (msg) {
        return Type._writeMessage(msg, new protoscript.BinaryWriter()).getResultBuffer();
    },
    /**
     * Deserializes Type from protobuf.
     */
    decode: function (bytes) {
        return Type._readMessage(Type.initialize(), new protoscript.BinaryReader(bytes));
    },
    /**
...
export const Field = {
     ...
     */
    encode: function (msg) {
        return Field._writeMessage(msg, new protoscript.BinaryWriter()).getResultBuffer();
    },
    /**
     * Deserializes Field from protobuf.
     */
    decode: function (bytes) {
        return Field._readMessage(Field.initialize(), new protoscript.BinaryReader(bytes));
    },
    /**
...
export const Enum = {
     ...
     */
    encode: function (msg) {
        return Enum._writeMessage(msg, new protoscript.BinaryWriter()).getResultBuffer();
    },
    /**
     * Deserializes Enum from protobuf.
     */
    decode: function (bytes) {
        return Enum._readMessage(Enum.initialize(), new protoscript.BinaryReader(bytes));
    },
    /**
...
export const EnumValue = {
     ...
     */
    encode: function (msg) {
        return EnumValue._writeMessage(msg, new protoscript.BinaryWriter()).getResultBuffer();
    },
    /**
     * Deserializes EnumValue from protobuf.
     */
    decode: function (bytes) {
        return EnumValue._readMessage(EnumValue.initialize(), new protoscript.BinaryReader(bytes));
    },
    /**
...
export const Option = {
     ...
     */
    encode: function (msg) {
        return Option._writeMessage(msg, new protoscript.BinaryWriter()).getResultBuffer();
    },
    /**
     * Deserializes Option from protobuf.
     */
    decode: function (bytes) {
        return Option._readMessage(Option.initialize(), new protoscript.BinaryReader(bytes));
    },
    /**
