...
type ClientMiddleware<T = unknown> = (context: MiddlewareConfig, next: (context: MiddlewareConfig) => Promise<T>) => Promise<T>;
type HookListener<MiddlewareConfig> = (context: Readonly<MiddlewareConfig>) => void;
type ErrorHookListener<MiddlewareConfig> = (context: Readonly<MiddlewareConfig>, err: TwirpError) => void;
...
type TwirpClientEvent<MiddlewareConfig> = Emitter<ClientHooks<MiddlewareConfig>>;
...
export type RpcTransport = (url: string, opts: RpcTransportOpts) => Promise<RpcTransportResponse>;
/**
