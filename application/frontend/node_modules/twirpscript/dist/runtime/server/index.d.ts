...
type ServerRequestWithBody<SR extends ServerRequest> = SR & Pick<Request, "body">;
...
export type TwirpContext<ContextExt = unknown, Services extends readonly Service[] = Service[]> = {
...
export type Middleware<Context = unknown, Request = unknown> = (request: Request, context: TwirpContext<Context>, next: Next) => Promise<Response>;
...
type ContextMethod<Context extends TwirpContext> = Exclude<Context["method"], undefined>;
