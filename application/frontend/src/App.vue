<template>
  ...
  >
    <div class="handlebar" @dblclick="maximise">
      <div class="handlebar-drag" style="--wails-draggable: drag" />
    </div>
    <suspense>
      <router-view />
    </suspense>
...
Events.On('blur', onWindowBlur)
Events.On('focus', onWindowFocus)
